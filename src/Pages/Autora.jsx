    ...
    return (
        <div className='caixa'>
            ...
            <footer className='footer_autora'>
                <ul>
                    <ol><a target='_blank' href="https://www.instagram.com/michellecoelho7/"  ><AiOutlineInstagram size='35' color='#fff' /></a></ol>
                    <ol><a target='_blank' href="https://github.com/micheleset7" ><AiOutlineGithub size='35' color='#fff' /></a></ol>
                    <ol><a target='_blank' href="https://www.linkedin.com/in/michele-coelho-5017aa79/" ><AiFillLinkedin size='35' color='#fff' /></a></ol>
                </ul>
